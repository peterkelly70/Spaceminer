#ifndef MANICROOMPAGE_HXX_INCLUDED
#define MANICROOMPAGE_HXX_INCLUDED
...
class ManicRoomPage : public ManicRoomNav
{
protected:
...
/* Overrides */
	...
	void itemAdd(int x, int y);
	void itemDel(int idx);
...
public:
	ManicRoomPage(ManicGame *game);
	virtual ~ManicRoomPage();
...
#endif //ndef MANICROOMPAGE_HXX_INCLUDED
