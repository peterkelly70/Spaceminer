...
class Jsw64TargetForm: public VideoForm, public TickListener
{
protected:
	VideoButton         *m_ok, *m_cancel;
	Room		    *m_dstRoom;
	jswByte		    *m_srcRoom;
	VideoBitmap	    *m_bmFixed, *m_bmAnim;
	VideoBitmap	    *m_bmWilly;
	int		     m_cx, m_cy;
	int		     m_px, m_py;
	int		     m_ticker;
public:
	Jsw64TargetForm(JswGame *g, Room *dstRoom, jswByte *srcRoom);
	virtual ~Jsw64TargetForm();
	virtual int doModal();
