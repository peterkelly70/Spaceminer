#ifndef JSW48TELPAGE_HXX_INCLUDED
#define JSW48TELPAGE_HXX_INCLUDED
...
class Jsw48TelPage : public Jsw48RoomNav
{
protected:
...
/* Overrides */
	...
	void drawTeleporter(int x, int y);	

	int onSelect(void);
public:
	Jsw48TelPage(JswGame *game);
	virtual ~Jsw48TelPage();
...
#endif //ndef JSW48TELPAGE_HXX_INCLUDED
