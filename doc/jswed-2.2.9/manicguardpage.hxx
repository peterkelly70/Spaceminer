#ifndef MANICGUARDPAGE_HXX_INCLUDED
#define MANICGUARDPAGE_HXX_INCLUDED
...
class ManicGuardPage : public ManicRoomNav
{
protected:
	int m_cyminor;		// For vertical guardians: "minor" cy, 0-7
	int m_cx, m_cy;		// Cursor coordinates
	int m_ocx, m_ocy;	// Cursor coordinates at start of drag
	int m_ctype;		// Current cell type (air, earth etc.)
	...
	jswByte m_attr;		// Attribute to paint with
...
public:
	ManicGuardPage(ManicGame *game);
	virtual ~ManicGuardPage();
...
#endif //ndef MANICGUARDPAGE_HXX_INCLUDED
