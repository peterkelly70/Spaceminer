...
# Node references
@onready var theme_path_edit: LineEdit = $HSplitContainer/LeftPanel/VBoxContainer/PathContainer/ThemePathEdit
@onready var load_button: Button = $HSplitContainer/LeftPanel/VBoxContainer/PathContainer/LoadButton
@onready var save_button: Button = $HSplitContainer/LeftPanel/VBoxContainer/ActionButtons/SaveButton
@onready var create_button: Button = $HSplitContainer/LeftPanel/VBoxContainer/ActionButtons/CreateButton
@onready var recent_themes_option: OptionButton = $HSplitContainer/LeftPanel/VBoxContainer/RecentContainer/RecentThemesOption
@onready var tab_container: TabContainer = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer
@onready var preview_container: Control = $HSplitContainer/PreviewPanel/ScrollContainer/PreviewContainer

# Editor tabs
@onready var fonts_tab: Control = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer/Fonts
@onready var colors_tab: Control = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer/Colors
@onready var styleboxes_tab: Control = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer/Styleboxes
@onready var constants_tab: Control = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer/Constants
@onready var icons_tab: Control = $HSplitContainer/LeftPanel/VBoxContainer/TabContainer/Icons
...
func _load_theme(path: String) -> void:
	if ResourceLoader.exists(path):
		...
		if theme_resource is Theme:
			...
			printerr("Selected file is not a Theme resource")
	else:
		printerr("Theme file does not exist: " + path)
...
func _save_theme(path: String) -> void:
	if _current_theme:
		...
		if err == OK:
			...
			print("Theme saved successfully to: " + path)
		else:
			printerr("Error saving theme: " + str(err))
